...
// 父组件
export default class Panent extends React.Component{
    constructor (props) {
        super (props);
        this.state = {
            msg: '这是父组件中的 msg 消息'
...
class Son extends React.Component{
    ...
    // 只有当 父组件 中, 通过 某些事件, 重新修改了 传递给子组件的 props 数据之后, 才会触发 componentWillReceiveProps
    componentWillReceiveProps (nextProps) {
        // console.log('被触发了 !');
        // 注意: 在 componentWillReceiveProps 被触发的时候, 如果我们使用 this.props 来获取属性值, 这个属性值是上一次的旧属性值
